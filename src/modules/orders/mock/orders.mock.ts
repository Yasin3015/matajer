...
export const mockOrders: Order[] = [
  { id: 'o1', orderNumber: '#1001', customerId: 'c1', customerName: 'Emma Wilson', customerEmail: 'emma@example.com', items: [{ productId: 'dp1', productName: 'Wireless Headphones', quantity: 1, price: 79.99 }], total: 79.99, status: 'delivered', storeSlug: 'demo-store', createdAt: '2024-04-01T10:00:00Z' },
  { id: 'o2', orderNumber: '#1002', customerId: 'c2', customerName: 'James Brown', customerEmail: 'james@example.com', items: [{ productId: 'dp2', productName: 'Smart Watch', quantity: 1, price: 149.99 }, { productId: 'dp4', productName: 'USB-C Hub', quantity: 2, price: 34.99 }], total: 219.97, status: 'processing', storeSlug: 'demo-store', createdAt: '2024-04-05T14:00:00Z' },
  { id: 'o3', orderNumber: '#1003', customerId: 'c3', customerName: 'Olivia Davis', customerEmail: 'olivia@example.com', items: [{ productId: 'dp3', productName: 'Portable Speaker', quantity: 1, price: 49.99 }], total: 49.99, status: 'shipped', storeSlug: 'demo-store', createdAt: '2024-04-08T09:00:00Z' },
