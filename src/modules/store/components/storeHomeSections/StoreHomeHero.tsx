      ...
      <div className="relative z-10 flex flex-1 items-center justify-start px-6 sm:px-12 lg:px-16 py-12">
        <div className="max-w-lg me-auto text-start">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm px-8 py-3.5 shadow-lg shadow-blue-900/20 transition-colors"
          >
            {t('home.hero.cta')}
          </Link>
        </div>
